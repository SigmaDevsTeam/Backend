...
//
//        when(userRepository.findById(writeCommentDTO.getUserId()))
//                .thenReturn(Optional.of(new User()));
//
//        when(questRepository.findById(writeCommentDTO.getUserId()))
//                .thenReturn(Optional.of(new Quest()));
//
//        when(commentMapper.toEntity(any(WriteCommentDTO.class), any(User.class), any(Quest.class)))
//                .thenReturn(comment);
//
...
//
//        CommentDTO result = commentService.writeComment(writeCommentDTO);
//
//        assertNotNull(result);
//        assertEquals(commentDTO.getId(), result.getId());
//
//        verify(userRepository).findById(writeCommentDTO.getUserId());
//        verify(questRepository).findById(writeCommentDTO.getQuestId());
//        verify(commentMapper).toEntity(any(WriteCommentDTO.class), any(User.class), any(Quest.class));
...
//
//        UserNotFoundException exception = assertThrows(UserNotFoundException.class, () -> commentService.writeComment(writeCommentDTO));
//        assertEquals("User with " + writeCommentDTO.getUserId() + " Id not found!", exception.getMessage());
//
//        verify(userRepository).findById(writeCommentDTO.getUserId());
//        verify(commentMapper, never()).toEntity(any(WriteCommentDTO.class), any(User.class), any(Quest.class));
//        verify(questRepository, never()).findById(writeCommentDTO.getQuestId());
...
//                .thenReturn(Optional.of(new User()));
//
//        when(questRepository.findById(writeCommentDTO.getQuestId()))
//                .thenReturn(Optional.empty());
//
//        QuestNotFoundException exception = assertThrows(QuestNotFoundException.class, () -> commentService.writeComment(writeCommentDTO));
//
//        assertEquals("Quest with Id " + writeCommentDTO.getQuestId() + " not found!", exception.getMessage());
//
//        verify(userRepository).findById(writeCommentDTO.getUserId());
//        verify(questRepository).findById(writeCommentDTO.getQuestId());
//        verify(commentMapper, never()).toEntity(any(WriteCommentDTO.class), any(User.class), any(Quest.class));
...
//
//        when(commentRepository.findById(editCommentDTO.getId()))
//                .thenReturn(Optional.of(comment));
//
//        when(commentMapper.toDTO(any(Comment.class)))
//                .thenReturn(commentDTO);
//
//        CommentDTO result = commentService.editComment(editCommentDTO);
//
//        assertNotNull(result);
//        assertEquals(commentDTO.getTitle(), result.getTitle());
//
//        verify(commentRepository).findById(editCommentDTO.getId());
//        verify(commentMapper).toDTO(any(Comment.class));
//
//    }
//
...
//                .thenReturn(Optional.empty());
//
//        assertThrows(CommentNotFoundException.class, () -> commentService.editComment(editCommentDTO));
//
//        verify(commentRepository).findById(editCommentDTO.getId());
//        verify(commentMapper, never()).toDTO(any(Comment.class));
//
